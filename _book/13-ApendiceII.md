...
- Kleiber, Christian y Claudio Lupi (2011). _Panel Unit Root Testing with R_. CRAN task views are visible at \url{http://cran.r-project.org/web/views/}.
...
- Sigmund, Michael y Robert Ferstl (nd). Panel Vector Autoregression in R with the Package panelvar. Electronic copy available at: \url{https://ssrn.com/abstract=2896087}
