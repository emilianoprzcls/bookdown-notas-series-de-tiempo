...
knitr::include_graphics("Pax_Metro.png")
```

<div class="figure" style="text-align: center">
<img src="Pax_Metro.png" alt="Evolución del número de pasajeros en el Metro de la CDMX, enero 2000 a junio de 2019" width="1181" />
...
Table: (\#tab:foo) Estadísticas descriptivas del número de pasajeros en el Metro de la CDMX, enero de 200 a junio de 2019
