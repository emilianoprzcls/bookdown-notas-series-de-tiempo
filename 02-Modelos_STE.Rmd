...
```{r fig31, echo=TRUE, message=FALSE, warning=FALSE, results='asis', fig.cap="Ejemplo de 10 trayectorias de la caminata aleatoria, cuando sólo es posible cambios de +1 y -1$", fig.align='center'}
...
```{r fig32, fig.cap = "Evolución del número de pasajeros en el Metro de la CDMX, enero 2000 a junio de 2019", fig.align='center', echo=TRUE, out.width="90%"}
...
```{r fig33, fig.cap = "Función de Autocorrelación: 150 rezagos del número de pasajeros en el Metro de la CCDMX, enero 2000 a junio de 2019", fig.align='center', echo=TRUE, out.width="90%"}
acf(Pax_Metro, 
    lag.max = 150, 
