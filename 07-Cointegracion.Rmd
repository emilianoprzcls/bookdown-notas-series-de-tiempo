...
```{r GCointegracion, fig.cap = "Series en niveles (logatirmos) y en diferencias logarítmicas para la prueba de Cointegración.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Cointegracion.png")
...
```{r GUCointegration, fig.cap = "Series en niveles (logatirmos) y en diferencias logarítmicas para la prueba de Cointegración.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_U_Cointegration.png")
