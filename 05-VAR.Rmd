...
```{r DLGranger, fig.cap = "Series en diferencias logarítmicas dadas por las siguientes expresiones: $DLINPC_t = ln(DLINPC_t) - ln(DLINPC_{t-1})$, $DLTC_t = ln(TC_t) - ln(TC_{t-1})$ y $DLCETE28_t = ln(CETE28_t) - ln(CETE28_{t-1})$.", fig.align='center', echo=FALSE, out.width="100%"}

par(mfrow=c(3, 1))

plot(DLINPC_G, xlab = "Tiempo", 
     main = "Diferencias Logarítmicas del INPC",
     col = "darkgreen")

plot(DLTC_G, xlab = "Tiempo", 
     main = "Diferencias Logarítmicas del Tipo de Cambio",
     col = "darkblue")

plot(DLCETE28_G, xlab = "Tiempo", 
...
```{r VARDLSeries, fig.cap = "Series en diferencias logarítmicas, enero de 2000 a julio de 201p", fig.align='center', echo=FALSE, out.width="100%", echo=TRUE, message=FALSE, warning=FALSE}
