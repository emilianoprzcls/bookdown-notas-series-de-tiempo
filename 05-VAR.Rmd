...
knitr::include_graphics("imagenes/DLGranger.png")
...
```{r VARDLSeries, fig.cap = "Series en diferencias logarítmicas, enero de 2000 a julio de 201p", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/VAR_DLSeries.png")
