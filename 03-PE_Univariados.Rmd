...
```{r GAR1Teo, fig.cap="$X_t = \\frac{5}{1 - 0.9} + \\sum_{j = 0}^{t-1} 0.9^j U_{t-j}$, y que $U_t \\sim \\mathcal{N}(0, 4)$}", fig.align='center', echo=FALSE, out.width="100%"}
...
```{r GAR1FACr, fig.cap="Función de autocorrelación de un AR(1): $\\rho(\\tau)=\\frac{\\gamma(\tau)}{\\gamma(0)}$", fig.align='center', echo=FALSE, out.width="100%"}
...
```{r GAR1FACt, fig.cap="Función de autocorrelación de un AR(1): $\\rho(\\tau)= a_1^\\tau$", fig.align='center', echo=FALSE, out.width="100%"}
...
```{r GAR1Com, fig.cap="AR(1) considerando en conjunto $X_t = 5 + 0.9 X_{t-1} + U_t$; $X_0 = 50$ y $X_t = \\frac{5}{1 - 0.9} + \\sum_{j = 0}^{t-1} 0.9^j U_{t-j}$, y que $U_t \\sim \\mathcal{N}(0, 4)$", fig.align='center', echo=FALSE, out.width="100%"}
