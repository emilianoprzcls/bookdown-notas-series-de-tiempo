...
```{r GPaxMetro, fig.cap="Pasajeros transportados (Millones) en el metro de la CDM en niveles y en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GPaxNal, fig.cap="Pasajeros transportados (Millones) en el metro de la CDM en niveles y en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r message=FALSE, echo=FALSE, message=FALSE, , echo=TRUE}
...
```{r GRootsAR2, echo=FALSE, fig.align='center', fig.cap="Inverso de las Raíces del polinomio característico.", message=FALSE, warning=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GPaxInt, fig.cap="Pasajeros en vuelos internacionales de salida en niveles y en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GRootsARp, fig.cap="Inverso de las Raíces del polinomio característico.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GRootsMAq, fig.cap = "Inverso de las Raíces del polinomio característico.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GRootsARMA11, fig.cap = "Inverso de las Raíces del polinomio característico de un ARMA(1,1)", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GResidualsARMA11, fig.cap = "Inverso de las Raíces del polinomio característico de un ARMA(1,1)", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GACFPACF, fig.cap = "Función de Autocorrelación y la Función de Autocorrelación Parcial de una serie $DLPaxNal_t$.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GResidualsARMA46, fig.cap = "Residuales del ARMA(4, 6) de una serie $DLPaxNal_t$.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r GResidualsARMA46D, fig.cap = "Residuales del ARMA(4, 6) de una serie $DLPaxNal_t$.", fig.align='center', echo=FALSE, out.width="100%", message=FALSE, , echo=TRUE}
...
```{r PaxNalf, fig.cap = "Pronóstico de la serie $PaxNAl_t$ a partir de una ARMA(4,6) en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%", echo=TRUE}
