...
```{r GAR1Real, fig.cap=".", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_AR_1_Real.png")
```
> Figura \@ref(fig:GAR1Com): AR(1) considerando $X_t=5+0.9X_{t-1}+U_t$ ; $X_0=50$ y que $U_t$~$N(0, 4)$ y que $U_t \sim \mathcal{N}(0, 4)$


```{r GAR1Teo, fig.cap=".", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_AR_1_Teo.png")

```
> Figura \@ref(fig:GAR1Teo): $X_t = \frac{5}{1 - 0.9} + \sum_{j = 0}^{t-1} 0.9^j U_{t-j}$, y que $U_t \sim \mathcal{N}(0, 4)$}

```{r GAR1FACr, fig.cap=".", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_AR_1_FACr.png")

```
> Figura \@ref(fig:GAR1FACr): Función de autocorrelación de un AR(1): $\rho(\tau)=\frac{\gamma(\tau)}{\gamma(0)}$

```{r GAR1FACt, fig.cap=".", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_AR_1_FACt.png")

```
> Figura \@ref(fig:GAR1FACr): Función de autocorrelación de un AR(1): $\rho(\tau)= a_1^\tau$

```{r GAR1Com, fig.cap=".", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_AR_1_Comb.png")
...
```{r GPaxMetro, fig.cap="Pasajeros transportados (Millones) en el metro de la CDM en niveles y en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Pax_Metro.png")
...
```{r GPaxNal, fig.cap="Pasajeros transportados (Millones) en el metro de la CDM en niveles y en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Pax_Nal.png")

```

```{r GRootsAR2, fig.cap="Inverso de las Raíces del polinomio característico.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Roots_AR2.png")
...
```{r GPaxInt, fig.cap="Pasajeros en vuelos internacionales de salida en niveles y en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Pax_Int.png")

```
```{r GRootsARp, fig.cap="Inverso de las Raíces del polinomio característico.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Roots_ARp.png")
...
```{r GRootsMAq, fig.cap = "Inverso de las Raíces del polinomio característico.", fig.align='center', echo=FALSE, out.width="100%"}
...
```{r GRootsARMA11, fig.cap = "Inverso de las Raíces del polinomio característico de un ARMA(1,1)", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Roots_ARMA11.png")
...
```{r GResidualsARMA11, fig.cap = "Inverso de las Raíces del polinomio característico de un ARMA(1,1)", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Residuals_ARMA11.png")
...
```{r GACFPACF, fig.cap = "Función de Autocorrelación y la Función de Autocorrelación Parcial de una serie $DLPaxNal_t$.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_ACF_PACF.png")
...
```{r GResidualsARMA46, fig.cap = "Residuales del ARMA(4, 6) de una serie $DLPaxNal_t$.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Residuals_ARMA46.png")
...
```{r GResidualsARMA46D, fig.cap = "Residuales del ARMA(4, 6) de una serie $DLPaxNal_t$.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/G_Residuals_ARMA46_D.png")
...
```{r PaxNalf, fig.cap = "Pronóstico de la serie $PaxNAl_t$ a partir de una ARMA(4,6) en diferencias logaritmicas.", fig.align='center', echo=FALSE, out.width="100%"}

knitr::include_graphics("imagenes/Pax_Nal_f.png")
